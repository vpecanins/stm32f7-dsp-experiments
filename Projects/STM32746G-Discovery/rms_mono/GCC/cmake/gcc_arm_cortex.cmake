...
# Just for making sure which plaform are we in
...
SET_PROPERTY(GLOBAL PROPERTY GlobalCHIP "${CHIP}")
SET_PROPERTY(GLOBAL PROPERTY GlobalCHIP_PLATFORM "${CHIP_PLATFORM}")
SET_PROPERTY(GLOBAL PROPERTY GlobalCHIP_FAMILY "${CHIP_FAMILY}")
...
FUNCTION(ARM_ADD_HEX_BIN_TARGETS TARGET)
	...
	ADD_CUSTOM_COMMAND(TARGET ${TARGET} POST_BUILD COMMAND ${CMAKE_OBJCOPY} -Oihex ${FILENAME} ${TARGET_DIR}${TARGET_WE}.hex)
	ADD_CUSTOM_COMMAND(TARGET ${TARGET} POST_BUILD COMMAND ${CMAKE_OBJCOPY} -Obinary ${FILENAME} ${TARGET_DIR}${TARGET_WE}.bin)
ENDFUNCTION()
...
FUNCTION(ARM_SET_TARGET_PROPERTIES TARGET)
	...
	ARM_ADD_HEX_BIN_TARGETS(${TARGET})
	ARM_PRINT_SIZE_OF_TARGETS(${TARGET})
ENDFUNCTION()
